...
class Solarbank2AC(Solarbank2):
    ...
    def usage_mode(self) -> str:
        ...
        A17C0 ``c405`` telemetry frame.  The Android APK has no matching
        local A17C0 setter: its observed short ``setBackPower`` command is an
        A17C1 control and must not be presented as an AC mode switch.
        """
        return {
            1: "Custom",
            2: "Self consumption",
